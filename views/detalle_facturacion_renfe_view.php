...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tabla-manipulacion-uti-renfe tfoot th').each(function(i) {
                var title = $('#tabla-manipulacion-uti-renfe thead th').eq($(this).index()).text();
                ...
                switch (i) {
                    ...
                    case 5: //columna
                        ...
                        break;
                    case 6: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:255px;"/>'); //fecha inicio facturacion
                        break;
                    case 7: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:200px;"/>'); //fecha fin facturacion
                        break;
                    case 8: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:125px;"/>'); //dias estancia
                        break;
                    case 9: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:300px;"/>'); //tarifa reducida
                        break;
                    case 10: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:300px;"/>'); //tarifa maxima
                        break;
                    case 11: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:355px;"/>'); //manipulacion adicional
                        break;
                    case 12: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:300px;"/>'); //exceso 7 dias
                        break;
                    default:
            ...
            table = $('#tabla-manipulacion-uti-renfe').DataTable({
            ...
            //Seleccion de filas
            $('#tabla-manipulacion-uti-renfe tbody').on('click', 'tr', function() {
            ...
            $("#tabla-manipulacion-uti-renfe").on("mouseenter", "tbody tr", function() {
                //stuff to do on mouse enter
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-manipulacion-uti-renfe tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
            ...
            $("#tabla-manipulacion-uti-renfe").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-manipulacion-uti-renfe tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
        ...
        <div class="container-fluid" id="page-wrapper">
            ...
            <div class="row" style="margin:0">
                ...
                <div class="well well-sm">
                    <a href="../controllers/excel_detalle_facturacion_cliente_controller.php?cliente=RENFE&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&tipo_facturacion=manipulacion_uti_renfe" type="button" id="" class="btn btn-success" title="manipulacion-uti-renfe"><i class="far fa-file-excel" aria-hidden="true"></i>MANIPULACION UTI RENFE</a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Im. Reducida: <i><?php echo $total_importe_reducida . ' €'; ?></strong></i></a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Im. Máxima: <i><?php echo $total_importe_maxima . ' €'; ?></strong></i></a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Im. Manipulación Adicional: <i><?php echo $total_importe_adicional . ' €'; ?></strong></i></a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Im. Exceso 7 días: <i><?php echo $total_importe_exceso_7_dias . ' €'; ?></strong></i></a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Total Importes: <i><?php echo $total_importe_manipulacion_utis . ' €'; ?></strong></i></a>
                </div>
                <table id="tabla-manipulacion-uti-renfe" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>Nº CONTENEDOR</th>
                            <th>TAMAÑO</th>
                            ...
                            <th>FECHA SALIDA</th>
                            <th>TIPO SALIDA</th>
                            <th>FECHA INICIO FACTURACIÓN</th>
                            <th>FECHA FIN FACTURACIÓN</th>
                            <th>DIÁS ESTANCIA</th>
                            <th>TARIFA REDUCIDA (0 - 2 DÍAS) (<?= $tarifa_reducida ?> €/UTI)</th>
                            <th>TARIFA MÁXIMA (HASTA 7 DÍAS) (<?= $tarifa_maxima ?> €/UTI)</th>
                            <th>MANIPULACIÓN ADICIONAL (MÁS DE 7 DÍAS) (<?= $tarifa_adicional ?> €/UTI)</th>
                            <th>EXCESO 7 DIAS TRANSITO (<?= $tarifa_exceso_7_dias ?> €/UTI/DÍA)</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <?php foreach ($manipulacion_uti_list as $manipulacion_uti_line) { ?>
                            <tr>
                                ...
                                <td><?php echo $manipulacion_uti_line['id_tipo_contenedor_iso']; ?></td>
                                ...
                                <td><?php echo $manipulacion_uti_line['fecha_inicio_facturacion']; ?></td>
                                <td><?php echo $manipulacion_uti_line['fecha_fin_facturacion']; ?></td>
                                <td><?php echo $manipulacion_uti_line['total_dias']; ?></td>
                                <td><?php echo $manipulacion_uti_line['importe_reducida'];
                                    echo ' €' ?></td>
                                <td><?php echo $manipulacion_uti_line['importe_maxima'];
                                    echo ' €' ?></td>
                                <td><?php echo $manipulacion_uti_line['importe_adicional'];
                                    echo ' €' ?></td>
                                <td><?php echo $manipulacion_uti_line['importe_exceso_7_dias'];
                                    echo ' €' ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
