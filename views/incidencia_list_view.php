...
<head>
    <title>Listado de Incidencias <?php echo $year; ?></title>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    case 0: //columna 0:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:140px;"/>'); //NUM INCIDENCIA
                        break;
                    case 1: //columna 1:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:100px;"/>'); //OPERACIONES
                        break;
                    case 2: //columna 2:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:120px;"/>'); //FECHA INCIDENCIA
                        break;
                    case 3: //columna 3:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:120px;"/>'); //TIPO INCIDENCIA
                        break;
                    case 4: //columna 4:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:150px;"/>'); //ESTADO INCIDENCIA
                        break;
                    case 5: //columna 5:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:150px;"/>'); //NUM CONTENEDOR
                        break;
                    case 6: //columna 6:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:150px;"/>'); //TRABAJADOR
                        break;
                    case 7: //columna 6:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:125px;"/>'); //FECHA INSERCCION 
                        break;
                    default:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:auto;"/>'); //OBSERVACIONES
                }
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Listado de Incidencias <?php echo $year; ?></h3>
                ...
                <table id="tabla" class="table table-bordered table-striped dataTable table-hover">
                    ...
                    <thead>
                        <tr>
                            <th class="danger">Numero Incidencia</th>
                            <th class="danger" class="noVis not-export-col">Operaciones</th>
                            <th class="danger">Fecha Incidencia</th>
                            <th class="danger">Tipo Incidencia</th>
                            <th class="danger">Estado Incidencia</th>
                            <th class="danger">Número Contenedor</th>
                            <th class="danger">Trabajador</th>
                            <th class="danger">Fecha Inserccion</th>
                            <th class="danger">Observaciones</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($incidencia_list as $incidencia_line) { ?>
                            ...
                            <tr id="<?php echo $incidencia_line['num_incidencia']; ?>">

                                <td><?php echo $incidencia_line['num_incidencia']; ?></td>
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a target="_blank" href="../controllers/incidencia_controller.php?id_incidencia=<?php echo $incidencia_line['id_incidencia']; ?>" type="button" id="<?php echo $incidencia_line['id_incidencia']; ?>" class="btn btn-sm btn-default view_record" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>
                                            <!-- <a target="_blank" href="../controllers/incidencia_controller.php?id_incidencia=<?php echo $incidencia_line['id_incidencia']; ?>&num_contenedor=<?php echo $incidencia_line['num_contenedor']; ?>" type="button" id="<?php echo $incidencia_line['id_incidencia']; ?>" class="btn btn-sm btn-default view_record" title="Ver"><span class="glyphicon glyphicon-eye-open"></span> -->
                                            </a>

                                        </div>
                                    </center>
                                </td>
                                <td><?php echo $incidencia_line['fecha_incidencia']; ?></td>
                                <td><?php echo $incidencia_line['tipo_incidencia']; ?></td>
                                <td><?php echo $incidencia_line['estado_incidencia']; ?></td>
                                <td><?php echo $incidencia_line['num_contenedor']; ?></td>
                                <td><?php echo $incidencia_line['user_insert']; ?></td>
                                <td><?php echo $incidencia_line['fecha_insert']; ?></td>
                                <td><?php echo $incidencia_line['observaciones']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
