...
<body>
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      ...
      <form class="form-inline" role="form" action="../controllers/traspasos_stats_controller.php" method="post">
        <br>
      ...
      <h3><center>ESTADÍSTICAS TRASPASOS</center></h3>

      <div class="row">
        <div class="col-sm-12 text-center">
          <h4><b>Cantidad de traspasos realizados en <?php echo $year_seleccionado; ?></b></h4>
          <!-- Este div contendrá el gráfico Donut -->
          <div id="pie-chart-traspasos" style="height: 300px;"></div>
        </div>
      </div>
    </div> <!-- page-wrapper -->
  </div> <!-- wrapper -->
