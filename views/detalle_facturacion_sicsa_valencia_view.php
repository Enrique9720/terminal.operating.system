...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tabla-manipulacion-uti-valencia tfoot th').each(function(i) {
                var title = $('#tabla-manipulacion-uti-valencia thead th').eq($(this).index()).text();
            ...
            table = $('#tabla-manipulacion-uti-valencia').DataTable({
            ...
            //Seleccion de filas
            $('#tabla-manipulacion-uti-valencia tbody').on('click', 'tr', function() {
            ...
            $("#tabla-manipulacion-uti-valencia").on("mouseenter", "tbody tr", function() {
            ...
            $("#tabla-manipulacion-uti-valencia").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-manipulacion-uti-valencia tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
            ...
            $(".DTFC_Cloned").on("mouseenter", "tbody tr", function() {
                ...
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-manipulacion-uti-valencia tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
            });
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            /////////////// FILTRADO DE REGISTROS DE TABLA POR TEXTO EN CADA COLUMNA
            // Setup - add a text input to each footer cell
            $('#tabla-almacenaje-valencia-20 tfoot th').each(function(i) {
                var title2 = $('#tabla-almacenaje-valencia-20 thead th').eq($(this).index()).text();
            ...
            // INICIALIZACION DATATABLE
            table = $('#tabla-almacenaje-valencia-20').DataTable({
                //texto para traducir datatables a español
                language: {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Ver _MENU_ filas",
            ...
            //Seleccion de filas
            $('#tabla-almacenaje-valencia-20 tbody').on('click', 'tr', function() {
                if ($(this).hasClass('active')) {
                    $(this).removeClass('active');
                } else {
                    table.$('tr.active').removeClass('active');
            ...
            //al pasar el cursor por una fila de la tabla hacemos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-20").on("mouseenter", "tbody tr", function() {
                //stuff to do on mouse enter
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-20 tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").addClass('hover');

            });

            //al salir el cursor de una fila de la tabla quitamos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-20").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-20 tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
            });
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            /////////////// FILTRADO DE REGISTROS DE TABLA POR TEXTO EN CADA COLUMNA
            // Setup - add a text input to each footer cell
            $('#tabla-almacenaje-valencia-40 tfoot th').each(function(i) {
                var title2 = $('#tabla-almacenaje-valencia-40 thead th').eq($(this).index()).text();
            ...
            // INICIALIZACION DATATABLE
            table = $('#tabla-almacenaje-valencia-40').DataTable({
                //texto para traducir datatables a español
                language: {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Ver _MENU_ filas",
            ...
            //Seleccion de filas
            $('#tabla-almacenaje-valencia-40 tbody').on('click', 'tr', function() {
                if ($(this).hasClass('active')) {
                    $(this).removeClass('active');
                } else {
                    table.$('tr.active').removeClass('active');
            ...
            //al pasar el cursor por una fila de la tabla hacemos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-40").on("mouseenter", "tbody tr", function() {
                //stuff to do on mouse enter
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-40 tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").addClass('hover');

            });

            //al salir el cursor de una fila de la tabla quitamos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-40").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-40 tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
            });
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            /////////////// FILTRADO DE REGISTROS DE TABLA POR TEXTO EN CADA COLUMNA
            // Setup - add a text input to each footer cell
            $('#tabla-almacenaje-valencia-45 tfoot th').each(function(i) {
                var title2 = $('#tabla-almacenaje-valencia-45 thead th').eq($(this).index()).text();
            ...
            // INICIALIZACION DATATABLE
            table = $('#tabla-almacenaje-valencia-45').DataTable({
                //texto para traducir datatables a español
                language: {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Ver _MENU_ filas",
            ...
            //Seleccion de filas
            $('#tabla-almacenaje-valencia-45 tbody').on('click', 'tr', function() {
                if ($(this).hasClass('active')) {
                    $(this).removeClass('active');
                } else {
                    table.$('tr.active').removeClass('active');
            ...
            //al pasar el cursor por una fila de la tabla hacemos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-45").on("mouseenter", "tbody tr", function() {
                //stuff to do on mouse enter
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-45 tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").addClass('hover');

            });

            //al salir el cursor de una fila de la tabla quitamos el hover tambien sobre la fila de la fixed column
            $("#tabla-almacenaje-valencia-45").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-almacenaje-valencia-45 tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
            });
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            /////////////// FILTRADO DE REGISTROS DE TABLA POR TEXTO EN CADA COLUMNA
            // Setup - add a text input to each footer cell
            $('#tabla-horas-extras-valencia tfoot th').each(function(i) {
                var title3 = $('#tabla-horas-extras-valencia thead th').eq($(this).index()).text();
                ...
                switch (i) {
                    case 0: //columna
                        ...
                        break;
                    case 1: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:75px;"/>'); //tamaño
                        break;
                    case 2: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:75px;"/>'); //tipo
                        break;
                    case 3: //columna
                        ...
                        break;
                    case 4: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:140px;"/>'); //fecha desconexion
                        break;
                    case 5: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:80px;"/>'); //total dias
                        break;
                    case 6: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:300px;"/>'); //importe temperatura
                        break;
                    case 7: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title3 + '" data-index="' + i + '" style="color:red; width:220px;"/>'); //importe conexion
                        break;
                    default:
            ...
            // INICIALIZACION DATATABLE
            table = $('#tabla-horas-extras-valencia').DataTable({
                //texto para traducir datatables a español
                language: {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Ver _MENU_ filas",
            ...
            //Seleccion de filas
            $('#tabla-horas-extras-valencia tbody').on('click', 'tr', function() {
                if ($(this).hasClass('active')) {
                    $(this).removeClass('active');
                } else {
                    table.$('tr.active').removeClass('active');
            ...
            //al pasar el cursor por una fila de la tabla hacemos el hover tambien sobre la fila de la fixed column
            $("#tabla-horas-extras-valencia").on("mouseenter", "tbody tr", function() {
                //stuff to do on mouse enter
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //añadimos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-horas-extras-valencia tbody').find("tr:eq(" + trIndex + ")").addClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").addClass('hover');

            });

            //al salir el cursor de una fila de la tabla quitamos el hover tambien sobre la fila de la fixed column
            $("#tabla-horas-extras-valencia").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-horas-extras-valencia tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
                $('.DTFC_Cloned tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
            });
        ...
        <div class="container-fluid" id="page-wrapper">
            ...
            <div class="row" style="margin:0">
                ...
                <div class="well well-sm">
                    <?php $nombre_comercial_cliente == 'SICSA-VALENCIA'; ?>
                    <a href="../controllers/excel_detalle_facturacion_cliente_controller.php?cliente=SICSA-VALENCIA&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&tipo_facturacion=manipulacion_uti" type="button" id="manipulacion_uti_sicsa_valencia" class="btn btn-success" title="excel" disabled><i class="far fa-file-excel" aria-hidden="true"> </i> MANIPULACION UTI SICSA-VALENCIA </a>
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Importe Manipulación Uti: <i><?php echo $total_importe_manipulacion_utis . ' €'; ?></strong></i></a>
                </div>
                <table id="tabla-manipulacion-uti-valencia" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>Nº CONTENEDOR</th>
                            <th>TAMAÑO</th>
            ...
            <div class="row" style="margin:0">
                ...
                <div class="well well-sm">
                    <?php $nombre_comercial_cliente == 'SICSA-VALENCIA'; ?>
                    <a href="../controllers/excel_detalle_facturacion_cliente_controller.php?cliente=SICSA-VALENCIA&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&tipo_facturacion=almacenaje" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> ALMACENAJE SICSA-VALENCIA </a>
                    ...
                    <a class="btn btn-default" onclick=""><i class="glyphicon glyphicon-euro"></i> <strong>Tl. Imp. Almacenaje: <i><?php echo $total_importe_almacenaje . ' €'; ?></strong></i></a>
                </div>
                <h4>ALMACENAJE 20'</h4>
                <table id="tabla-almacenaje-valencia-20" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>FECHA STOCK</th>
                            <th>ENTRADA 20'</th>
                ...
                <h4>ALMACENAJE 40'</h4>
                <table id="tabla-almacenaje-valencia-40" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>FECHA STOCK</th>
                            <th>ENTRADA 40'</th>
                ...
                <h4>ALMACENAJE 45'</h4>
                <table id="tabla-almacenaje-valencia-45" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>FECHA STOCK</th>
                            <th>ENTRADA 45'</th>
            ...
            <div class="row" style="margin:0">
                ...
                <div class="well well-sm">
                    <?php $nombre_comercial_cliente == 'SICSA-VALENCIA'; ?>
                    <!-- href="../controllers/excel_detalle_facturacion_cliente_controller.php?cliente=SICSA-VALENCIA&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&tipo_facturacion=horas_extras" -->
                    <a type="button" id="" class="btn btn-success" title="excel" disabled><i class="far fa-file-excel" aria-hidden="true"></i> HORAS EXTRAS SICSA-VALENCIA </a>
                ...
                <table id="tabla-horas-extras-valencia" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>FECHA</th>
