...
<head>
	<title>Resumen Salida Transbordo <?php echo $num_transbordo ?></title>
	...
	<script>
		$(document).ready(function() {
			...
			table_lineas_salida = $('#table_lineas_salida').DataTable({
				columns: [{
						data: 'num_contenedor'
					},
					{
				...
				<div class="col-md-12" style="padding-top:10px;">
					...
					<div class="col-sm-6">
						<table id="table_transbordo_resumen" class="table table-striped table-bordered" style="font-size: 12px;">
							...
							<tbody>
								<?php foreach ($salida_transbordo_list as $salida_transbordo_line) { ?>
									<tr>
										<td><?php echo $salida_transbordo_line['id_transbordo']; ?></td>
										<td><?php echo $salida_transbordo_line['fecha_transbordo']; ?></td>
										<td><?php echo $salida_transbordo_line['num_contenedor_origen']; ?></td>
										<td><?php echo $salida_transbordo_line['num_contenedor_destino']; ?></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
