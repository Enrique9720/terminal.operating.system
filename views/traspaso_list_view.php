...
<head>
    <title>Listado Traspasos <?php echo $year;?></title>
            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    ...
                    case 1: //columna 1:
                        ...
                        break;
                    case 2: //columna 2:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:115px;"/>'); //FECHA TRASPASO
                        break;
                    case 3: //columna 3:
                        ...
                        break;
                    case 4: //columna 4:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:135px;"/>'); //PROPIETARIO ANTERIOR
                        break;
                    case 5: //columna 5:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:135px;"/>'); //PROPIETARIO ACTUAL
                        break;
                    case 6: //columna 6:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:70px;"/>'); //ESTADO
                        break;
                    case 7: //columna 7:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:145px;"/>'); //TIPO MERCANCIA
                        break;
                    case 8: //columna 8:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:120px;"/>'); //TIPO MERCANCIA
                        break;
                    case 9: //columna 9:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:100px;"/>'); //TIPO MERCANCIA
                        break;
                    default:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:100px;"/>');; //DESTINATARIO
                }
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Listado Traspasos <?php echo $year;?></h3>
                ...
                <table id="tabla" class="table table-bordered table-striped dataTable table-hover">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($traspasos_list as $traspasos_line) { ?>
                            ...
                            <tr id="<?php echo $traspasos_line['id_traspaso']; ?>">

                                <td><?php echo $traspasos_line['id_traspaso']; ?></td>
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a target="_blank" href="../controllers/traspaso_controller.php?id_traspaso=<?php echo $traspasos_line['id_traspaso']; ?>" type="button" id="<?php echo $traspasos_line['id_traspaso']; ?>" class="btn btn-sm btn-default view_record" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>
                                        </div>
                                    </center>
                                </td>
