...
<head>
    <title>Histórico Contenedores</title>
            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    case 0: //columna 0:
                        ...
                        break;
                    case 1: //columna 1:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:120px;"/>'); //Operaciones
                        break;
                    case 2: //columna 2:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:75px;"/>'); //Tipo
                        break;
                    case 3: //columna 3:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:100px;"/>'); //Longitud
                        break;
                    case 4: //columna 4:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:140px;"/>'); //Descripción
                        break;
                    case 5: //columna 4:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:90px;"/>'); //Tara
                        break;
                    case 6: //columna 5:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:140px;"/>'); // Propietario
                        break;
                    default:
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <table id="tabla" class="table table-bordered table-striped dataTable table-hover">
                    ...
                    <tbody>
                        <?php foreach ($contenedores_list as $contenedores_line) { ?>
                            <tr id="<?php echo $contenedores_line['num_contenedor']; ?>">
                                <td><?php echo $contenedores_line['num_contenedor']; ?></td>
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a target="_blank" href="../controllers/historico_contenedor_controller.php?num_contenedor=<?php echo $contenedores_line['num_contenedor']; ?>" type="button" id="<?php echo $contenedores_line['num_contenedor']; ?>" class="btn btn-sm btn-default view_record" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>
                                        </div>
                                    </center>
                                </td>
                                <td><?php echo $contenedores_line['id_tipo_contenedor_iso']; ?></td>
                                <td><?php echo $contenedores_line['longitud_tipo_contenedor']; ?></td>
                                <td><?php echo $contenedores_line['descripcion_tipo_contenedor']; ?></td>
                                <td><?php echo $contenedores_line['tara_contenedor']; ?></td>
                                <td><?php echo $contenedores_line['nombre_comercial_propietario']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
