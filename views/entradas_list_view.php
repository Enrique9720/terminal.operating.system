    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Listado Entradas Contenedores</h3>
                <div class="well well-sm">
                    <button class="btn btn-default" onclick="window.location.reload()">
                        <i class="glyphicon glyphicon-refresh"></i> Recargar
                    </button>
                    <a href="../controllers/excel_entradas_list_controller.php?year=<?php echo $year;?>" type="button" id="listado_entradas" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> EXCEL LISTADO ENTRADAS</a>
                </div>
                ...
                <table id="tabla" class="table table-bordered dataTable table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="noVis not-export-col success">Operaciones</th>
                            <th class="success">Fecha Entrada</th>
                            <th class="success">Tipo</th>
                            <th class="success">Propietario</th>
                            <th class="success">Nº Contenedores</th>
                            <th class="success">Contenedores</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <?php foreach ($entradas_list as $entradas_line) { ?>
                            <tr id="<?php echo htmlspecialchars($entradas_line['id_entrada'], ENT_QUOTES, 'UTF-8'); ?>">
                                <td><?php echo htmlspecialchars($entradas_line['num_expedicion'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a target="_blank"
                                                href="../controllers/entrada_resumen_controller.php?id_entrada=<?php echo htmlspecialchars($entradas_line['id_entrada'], ENT_QUOTES, 'UTF-8'); ?>"
                                ...
                                <td><?php echo htmlspecialchars($entradas_line['fecha_entrada'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($entradas_line['tipo_entrada'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($entradas_line['nombre_comercial_propietario'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td><?php echo htmlspecialchars($entradas_line['contenedores'][0]['total_contenedores'], ENT_QUOTES, 'UTF-8'); ?></td>
                                <td>
                                    <table class="table table-bordered">
                                        <?php if (in_array($entradas_line['tipo_entrada'], ['TREN', 'CAMIÓN', 'TRASPASO'])) { ?>
                                            <thead>
                                                <tr>
                                                    <th>Nº Contenedor</th>
                                                    <th>Tipo</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($entradas_line['contenedores'] as $contenedor) { ?>
                                                    <tr>
