...
<div class="modal fade" id="modal_cita_carga_view_record" role="dialog">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <center>
          <h4 class="modal-title" id="modal_cita_carga_view_record_title">Modal title</h4>
        </center>
      </div>
      ...
      <div class="modal-body">
        ...
        <div class="row">
          <div class="col-sm-12">
            <table id="table_lineas_carga" class="table table-striped table-bordered dataTable table-hover">
              <thead>
                <tr>
                  <th>Nº Contenedor</th>
                  <th>Tipo</th>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="guardar_carga"><i class="fa fa-sm fa-save" aria-hidden="true"></i> Guardar</button>
        <button type="button" class="btn btn-success" id="editar_carga"><i class="fa fa-sm fa-pencil" aria-hidden="true"></i> Editar</button>
...
<script>
  ...
  $(document).ready(function(){
    table_lineas_carga = $('#table_lineas_carga').DataTable({
      columns: [
        { data: 'num_contenedor' },
...
/*
    table = $('#contenedor_view').DataTable( {
     ...
     $(document).on('click', '#lineas_carga_button', function(event){
       ...
       $("#modal_cita_view_record_title").html('<strong>Contenedores a Cargar</strong>');
       $("#modal_cita_view_record").modal();
