            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    ...
                    case 5: //columna 4:
                        ...
                        break;
                    case 6: //columna 5:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:85px;"/>'); //ID Entrada
                        break;
                    case 7: //columna 6:
                    ...
                    case 10: //columna 9:
                        ...
                        break;
                    case 11: //columna 10:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:80px;"/>'); //Nº Vagon
                        break;
                    case 12: //columna 11:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:90px;"/>'); //Pos Vagon
                        break;
                    case 13: //columna 12:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:120px;"/>'); //Pos Contenedor
                        break;
                    case 14: //columna 13:
                    ...
                    case 20: //columna 19:
                        ...
                        break;
                    case 21: //columna 20:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:80px;"/>'); //ID Salida
                        break;
                    case 22: //columna 21:
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <div class="well well-sm"> 
                    <!-- href="../controllers/excel_historico_movimientos_propietario_controller.php?propietario=CCIS-BILBAO" -->
                    <a type="button" id="" class="btn btn-success" title="excel" disabled><i class="far fa-file-excel" aria-hidden="true"></i> Movimientos CCIS-BILBAO</a>
                    <!-- href="../controllers/excel_historico_movimientos_propietario_controller.php?propietario=SICSA-VALENCIA" -->
                    <a type="button" id="" class="btn btn-success" title="excel" disabled><i class="far fa-file-excel" aria-hidden="true"></i> Movimientos SICSA-VALENCIA</a>
                ...
                <table id="tabla" class="table table-bordered dataTable table-hover">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="success">ID Entrada</th>
                            <th class="success">Expedición Entrada</th>
                            <th class="success">Fecha Entrada</th>
                            <th class="success">Tipo Entrada</th>
                            <th class="success">Destinatario</th>
                            <th class="success">Nº Vagón</th>
                            <th class="success">Pos. Vagón</th>
                            <th class="success">Pos. Contenedor</th>
                            ...
                            <th class="danger">Destinatario</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <?php foreach ($historico_list as $historico_line) { ?>
                            <tr id="<?php echo $historico_line['num_contenedor']; ?>">
                                <td><?php echo $historico_line['num_contenedor']; ?></td>
                                <td><?php echo $historico_line['id_tipo_contenedor_iso']; ?></td>
                                <td><?php echo $historico_line['longitud_tipo_contenedor']; ?></td>
                                <td><?php echo $historico_line['descripcion_tipo_contenedor']; ?></td>
                                <td><?php echo $historico_line['tara_contenedor']; ?></td>
                                <td><?php echo $historico_line['nombre_comercial_propietario']; ?></td>
                                <td><?php echo $historico_line['id_entrada']; ?></td>
                                <td><?php echo $historico_line['num_expedicion_entrada']; ?></td>
                                ...
                                <td><?php echo $historico_line['num_vagon']; ?></td>
                                <td><?php echo $historico_line['pos_vagon']; ?></td>
                                <td><?php echo $historico_line['pos_contenedor']; ?></td>
                                ...
                                <td><?php echo $historico_line['id_salida']; ?></td>
                                <td><?php echo $historico_line['num_expedicion_salida']; ?></td>
