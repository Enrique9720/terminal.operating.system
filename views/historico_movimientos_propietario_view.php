...
<head>
    <title>Histórico Movimientos <?php echo $nombre_comercial_propietario; ?></title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Histórico Movimientos <?php echo $nombre_comercial_propietario; ?></h3>
                <div class="well well-sm">
                    <?php if ($nombre_comercial_propietario == 'CCIS-BILBAO' || $nombre_comercial_propietario == 'SICSA-VALENCIA') { ?>
                        <a href="../controllers/excel_historico_movimientos_propietario_controller.php?propietario=CCIS-BILBAO_SICSA-VALENCIA&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> CCIS-BILBAO & SICSA-VALENCIA</a>
                    <?php } else if ($nombre_comercial_propietario == 'RENFE') { ?>
                        <a href="../controllers/excel_historico_movimientos_propietario_controller.php?propietario=RENFE&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&entrada_camion" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> ENTRADA CAMIÓN RENFE</a>
                        <a href="../controllers/excel_historico_movimientos_propietario_controller.php?propietario=RENFE&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&salida_camion" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> SALIDA CAMIÓN RENFE</a>
                    <?php } ?>
                    <a class="btn btn-default" onclick="window.location.reload()"><i class="glyphicon glyphicon-refresh"></i> Recargar</a>
                </div>

                <form class="form-inline" action="../controllers/historico_movimientos_propietario_controller.php?propietario=<?php echo $nombre_comercial_propietario; ?>" method="POST">
                    <div class="row">
