...
<head>
	...
	<title>Estadísticas de Partes de Trabajo <?php echo htmlspecialchars($year_seleccionado); ?></title>
</head>
...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<form class="form-inline" role="form" action="../controllers/parte_trabajo_stats_controller.php" method="post">
				<br>
			...
			<h3>
				<b><center>ESTADÍSTICAS PARTES DE TRABAJO</center></b>
			</h3>
			...
			<div class="row">
				<div class="col-sm-12 text-center">
					...
					<div id="pie-chart-parte-trabajo" style="height: 500px;"></div>
				</div>
			</div>
		</div> <!-- page-wrapper -->
	</div> <!-- wrapper -->
