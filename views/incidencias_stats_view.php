...
<head>
  ...
  <title>Estadísticas de Incidencias <?php echo htmlspecialchars($year_seleccionado); ?></title>
</head>
<body>
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      ...
      <form class="form-inline" role="form" action="../controllers/incidencias_stats_controller.php" method="post">
        <br>
      ...
      <h3><center>ESTADÍSTICAS INCIDENCIAS</center></h3>

      <div class="row">
        <div class="col-sm-12 text-center">
          <h4><b>Incidencias por Tipo</b></h4>
          <!-- Este div contendrá el gráfico Donut -->
          <div id="pie-chart-incidencias" style="height: 500px;"></div>
        </div>
      </div>
    </div> <!-- page-wrapper -->
  </div> <!-- wrapper -->
