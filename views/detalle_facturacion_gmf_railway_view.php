...
<head>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tabla-manipulacion-uti tfoot th').each(function(i) {
                var title = $('#tabla-manipulacion-uti thead th').eq($(this).index()).text();
                ...
                switch (i) {
                    ...
                    case 1: //columna
                        ...
                        break;
                    case 2: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:225px;"/>'); //fecha entrada
                        break;
                    case 3: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:180px;"/>'); //tipo entrada
                        break;
                    case 4: //columna
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:325px;"/>'); //fecha salida
                        break;
                    default:
            ...
            table = $('#tabla-manipulacion-uti').DataTable({
            ...
            //Seleccion de filas
            $('#tabla-manipulacion-uti tbody').on('click', 'tr', function() {
            ...
            $("#tabla-manipulacion-uti").on("mouseenter", "tbody tr", function() {
            ...
            $("#tabla-manipulacion-uti").on("mouseleave", "tbody tr", function() {
                //stuff to do on mouse leave
                //cogemos el indice de la fila en la tabla
                trIndex = $(this).index();
                //quitamos la clase hover a la fila correspondiente de la fixed column
                $('#tabla-manipulacion-uti tbody').find("tr:eq(" + trIndex + ")").removeClass('hover');
        ...
        <div class="container-fluid" id="page-wrapper">
            ...
            <div class="row" style="margin:0">
                ...
                <div class="well well-sm">
                    <!-- href="../controllers/excel_detalle_facturacion_cliente_controller.php?cliente=GMF-RAILWAY&fecha_inicio=<?php echo $fecha_inicio; ?>&fecha_fin=<?php echo $fecha_fin; ?>&tipo_facturacion=maniobra_generadores" -->
                    <a type="button" id="" class="btn btn-success" title="excel" disabled><i class="far fa-file-excel" aria-hidden="true"></i> MANIOBRAS GENERADORES GMF-RAILWAY </a>
                ...
                <table id="tabla-manipulacion-uti" class="table table-bordered table-striped dataTable table-hover">
                    <thead>
                        <tr>
                            <th>FECHA TREN</th>
                            <th>TIPO MOVIMIENTO</th>
                            <th>Nº EXPEDICION ENTRADA TREN</th>
                    ...
                    <tbody>
                        <?php foreach ($maniobra_gmf_railway_list as $maniobra_gmf_railway_line) { ?>
                            <tr>
                                <td><?php echo $maniobra_gmf_railway_line['Fecha de Tren']; ?></td>
                                <td><?php echo $maniobra_gmf_railway_line['Tipo de Movimiento']; ?></td>
                                <td><?php echo $maniobra_gmf_railway_line['Número de Expedición']; ?></td>
                                <td><?php echo $maniobra_gmf_railway_line['Origen-Destino']; ?></td>
                                <td><?php echo $maniobra_gmf_railway_line['importe_maniobra_terminal']; ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
