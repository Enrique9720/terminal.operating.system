...
<head>
    <title>Stock Contenedores <?php echo $nombre_comercial_propietario;?></title>
            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    ...
                    case 5: //columna 5:
                        ...
                        break;
                    case 6: //columna 6:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:160px;"/>');//Propietario
                        break;
                    case 7: //columna 7:
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Stock Contenedores <?php echo $nombre_comercial_propietario;?></h3>
                <div class="well well-sm">
                  <?php if($nombre_comercial_propietario == 'CCIS-BILBAO' || $nombre_comercial_propietario == 'SICSA-VALENCIA'){?>
                    <a href="../controllers/excel_stock_propietario_controller.php?propietario=CCIS-BILBAO_SICSA-VALENCIA&fecha_stock=<?php echo $fecha_stock;?>" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> Stock CCIS-BILBAO & SICSA-VALENCIA</a>
                  <?php }else if($nombre_comercial_propietario == 'RENFE'){?>
                    <a href="../controllers/excel_stock_propietario_controller.php?propietario=RENFE&fecha_stock=<?php echo $fecha_stock;?>" type="button" id="" class="btn btn-success" title="excel"><i class="far fa-file-excel" aria-hidden="true"></i> Stock RENFE</a>
                  <?php }?>
                  <a class="btn btn-default" onclick="window.location.reload()"><i class="glyphicon glyphicon-refresh"></i> Recargar</a>
                </div>

                <form class="form-inline" action="../controllers/stock_contenedores_propietario_controller.php?propietario=<?php echo $nombre_comercial_propietario;?>" method="POST">
                  <div class="row">
