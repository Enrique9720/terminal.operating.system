...
<head>
    <title>Listado Transbordos <?php echo $year; ?></title>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tabla tfoot th').each(function(i) {
                ...
                switch (i) {
                    case 0: //columna 0:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:50px;"/>'); //id_transbordo
                        break;
                    case 1: //columna 1:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:100px;"/>'); //BOTON
                        break;
                    case 2: //columna 2:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:130px;"/>'); //fecha_transbordo
                        break;
                    case 3: //columna 3:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:150px;"/>'); //num_contenedor_origen
                        break;
                    case 4: //columna 0:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:170px;"/>'); //peso mercancia origen
                        break;
                    case 5: //columna 1:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:160px;"/>'); //num_contenedor_destino
                        break;
                    case 6: //columna 2:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:170px;"/>'); //peso mercancia origen
                        break;
                    ...
                    default:
                        $(this).html('<input type="text" class="form-control input-sm" placeholder="' + title + '" data-index="' + i + '" style="color:red; width:160px;"/>'); //
                }
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid" id="page-wrapper">
            <div class="row h-100" style="margin:0">
                ...
                <h3>Listado Transbordos <?php echo $year; ?></h3>
                ...
                <table id="tabla" class="table table-bordered table-striped dataTable table-hover">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($transbordos_list as $transbordos_line) { ?>
                            ...
                            <tr id="<?php echo $transbordos_line['id_transbordo']; ?>">

                                <td><?php echo $transbordos_line['id_transbordo']; ?></td>
                                <td>
                                    <center>
                                        <div class="btn-group">
                                            <a target="_blank" href="../controllers/transbordo_controller.php?id_transbordo=<?php echo $transbordos_line['id_transbordo']; ?>" type="button" id="<?php echo $transbordos_line['id_transbordo']; ?>" class="btn btn-sm btn-default view_record" title="Ver"><span class="glyphicon glyphicon-eye-open"></span></a>
                                        </div>
                                    </center>
                                </td>
