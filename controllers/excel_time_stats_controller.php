...
require_once "../functions/excel_time_stats_functions.php";

//obtener mes y año actual
$year_actual = date("Y");
$month_actual = date("m");
//echo $year_actual . " - " . $month_actual . "<br>";
...
//echo "<pre>";
//print_r($time_stats_list);
//echo "</pre>";

excel_iso_9001_marcadores_tiempo($time_stats_list);
