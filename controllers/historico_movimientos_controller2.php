...
$historico_contenedores_list = $railsider_model->get_contenedores_historico(); //HISTORICO CONTENEDORES

//echo "<pre>";
//print_r($historico_contenedores_list);
//echo "</pre>";

if (count($historico_contenedores_list) > 0) {

	foreach ($historico_contenedores_list as $key => $value) {
		...
		if ($tipo_salida == 'TREN') { //SALIDA
			//$salida_tren_list = $railsider_model->get_salida_tipo_tren_por_id_salida_por_num_contenedor_historico($id_salida, $num_contenedor);
...
/////////////////////////////////////////////////////////
//cargamos la vista
require_once('../views/historico_movimientos_view2.php');
