...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (!empty($year_seleccionado)) {
        ...
        $transbordos_year = $railsider_model->get_transbordos_por_year($year_seleccionado);
        
        // Armamos el arreglo para el gráfico Donut
        foreach ($transbordos_year as $tipo) {
            $datos_donut_chart[] = array(
                'label' => $year_seleccionado,//$tipo['tipo_incidencia'],
...
// Cargamos la vista
require_once('../views/transbordos_stats_view.php');